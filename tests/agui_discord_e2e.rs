// ABOUTME: End-to-end test of in-process AG-UI event consumption driving Discord PATCH messages status edits
// ABOUTME: Replays a run's event broadcast into the status adapter against a mock Discord REST API
//
